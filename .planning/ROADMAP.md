...
Plans:
- [ ] 04-01-PLAN.md — Language design: grammar scope, AST, authored rule examples, and `before()`-only semantic contract
...
| 4. DSL Scope and Semantic Contract | v1.1 | 0/2 | Pending | - |
